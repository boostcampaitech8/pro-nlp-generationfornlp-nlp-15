...
async def load_test_data(
    ...
    Args:
        ...
        skip_classification: True면 문제 유형 분류 스킵하고 DEFAULT 사용 (기본값: False)
    """
    ...
    if skip_classification:
        # 분류 스킵: 모든 문제를 DEFAULT 타입으로 설정
        for example in tqdm(qa_examples, desc="Loading data (classification skipped)"):
            test_data.append({
                "id": example.id,
